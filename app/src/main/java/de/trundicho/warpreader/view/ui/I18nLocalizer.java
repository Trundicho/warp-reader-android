...
public class I18nLocalizer {
    ...
    private static final String WARPREADER_INITIAL_TEXT = "WarpReader Copy and paste your text or URL into the text field and start reading. As you get faster just increase the tempo as much as you like. Have fun reading at warp speed with WarpReader";
